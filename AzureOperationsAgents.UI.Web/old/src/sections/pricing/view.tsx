...
// ----------------------------------------------------------------------
    const _pricingPlans = [
    
        {
            ...
            lists: [t('pricing-plans.common-options')],
            labelAction: t('pricing-plans.current-plan'),
        ...
        },
        {
            ...
            lists: t('pricing-plans.personal-options').split(','),
            labelAction: t('pricing-plans.choose-personal'),
            cadence: yearly ? t('pricing-plans.year') : t('pricing-plans.month'),
        },
        {
            ...
            lists: t('pricing-plans.professional-options').split(','),
            labelAction: t('pricing-plans.choose-professional'),
            cadence: yearly ? t('pricing-plans.year') : t('pricing-plans.month'),
        },
        {
            ...
            lists: t('pricing-plans.team-options').split(','),
            labelAction: t('pricing-plans.choose-team'),
            cadence: yearly ? t('pricing-plans.year') : t('pricing-plans.month'),
        }
    ];
// ----------------------------------------------------------------------
  ...
  return (
    ...
    >
      <Typography variant="h3" align="center" sx={{ mb: 2 }}>
          {t('pricing-plans.flexible-plans')}
      </Typography>

      <Typography align="center" sx={{ color: 'text.secondary' }}>
          {t('pricing-plans.choose-your-plan')}
      </Typography>

      <Box sx={{ mt: 9, mb: 5, position: 'relative' }}>
        <Stack direction="row" alignItems="center" justifyContent="center">
          <Typography variant="overline">{t('pricing-plans.monthly')}</Typography>
          ...
          <Box sx={{ position: 'relative' }}>
            <Stack direction="row" sx={{ position: 'absolute', left: 12, bottom: 12 }}>
              ...
              >
                  {t('pricing-plans.save-10')}
              </Box>
            </Stack>

            <Typography variant="overline">{t('pricing-plans.yearly')}</Typography>
          </Box>
        </Stack>
      </Box>

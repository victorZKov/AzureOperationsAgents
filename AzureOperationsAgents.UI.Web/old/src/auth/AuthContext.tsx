...
import { AD_API, HOST_API_KEY } from "../config-global";
import {
    ActionMapType,
    AuthStateType,
    AuthUserType,
...
export const msalConfig: Configuration = {
    auth: {
        ...
        knownAuthorities: [AD_API.authority],
...
export function AuthProvider({ children }: AuthProviderProps) {
    ...
    const currentLang = i18n.getFixedT(i18n.language);
    const [isLoginInProgress, setIsLoginInProgress] = useState(false);

    // Get current language - centralized function
    const getCurrentLanguage = useCallback(() => {
        return i18n.language || localStorage.getItem("i18nextLng") || currentLang;
    }, [currentLang]);
    ...
    const doLogin = useCallback(async () => {
        ...
        try {
            ...
            console.log('Redirect URI:', AD_API.redirectUri);
